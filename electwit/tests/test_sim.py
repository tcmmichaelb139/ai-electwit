...
def test_simulation():
    ...
    sim = ElecTwit(
        people_models="openai/o3-mini;2,google/gemini-2.5-flash;2,anthropic/claude-3.5-haiku;2,deepseek/deepseek-chat-v3-0324;2,qwen/qwq-32b;2,x-ai/grok-3-mini;2,meta-llama/llama-4-maverick;2",
